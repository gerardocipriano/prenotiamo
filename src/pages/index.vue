    ...
    <div class="row d-flex justify-content-center align-items-center ">
      <div class="col col-xl-10">
          <div class="row g-0">
            ...
            <p>Ti ricordiamo che il pasto viene inoltrato alla mensa entro le 11.30. Dopo tale orario non sarà più possibile modificarlo da qui.</p>
            <p>Per utilizzare i servizi, effettua l'accesso al portale.</p>
            </div>
            </div>
          </div>
      </div>
